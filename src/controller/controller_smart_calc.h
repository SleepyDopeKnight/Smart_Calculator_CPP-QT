#ifndef CPP3_SMARTCALC_CONTROLLER_CONTROLLER_SMART_CALC_H_
#define CPP3_SMARTCALC_CONTROLLER_CONTROLLER_SMART_CALC_H_
...
#endif  // CPP3_SMARTCALC_CONTROLLER_CONTROLLER_SMART_CALC_H_
