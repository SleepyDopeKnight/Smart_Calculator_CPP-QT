#ifndef SMART_CALCULATOR_CPP_MODEL_MODEL_FINANCE_CALC_H_
#define SMART_CALCULATOR_CPP_MODEL_MODEL_FINANCE_CALC_H_
...
#endif  // SMART_CALCULATOR_CPP_MODEL_MODEL_FINANCE_CALC_H_
